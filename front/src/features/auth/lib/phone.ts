 ...
 *
 * Поле намеренно лояльно к вводу (требование макета): принимаются `8…`, `+7…`,
 * номер без кода страны, со скобками, пробелами и тире. Возвращает `null`,
 * если из строки не получается российский номер.
 */

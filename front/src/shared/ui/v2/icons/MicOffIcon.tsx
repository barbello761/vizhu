...
/**
 * Микрофон выключен. Нарисован ровно теми же контурами, что `MicIcon`, плюс
 * перечёркивающая линия той же толщины — иначе в паре кнопок «вкл/выкл»
 * состояния выглядят разновесно: прежняя иконка была набрана сплошной
 * заливкой и казалась заметно жирнее включённой.
 */
export const MicOffIcon = ({ className }: IconProps) => (
  ...
  >
    ...
    <path
      ...
      fill="currentColor"
    />
    <path d="M5 4L27 26" stroke="currentColor" strokeWidth="2" strokeLinecap="round" />
  </svg>
);

...
/**
 * Реализован как `tablist` с автоматической активацией: стрелки сразу переключают
 * раздел, потому что каждая вкладка показывает уже загруженный список — состояния
 * «выбрал, но не открыл» тут нет, и лишний Enter только удлинил бы путь для
